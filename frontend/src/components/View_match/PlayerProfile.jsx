        ...
        const fetchProfile = async () => {
            try {
                const response = await axios.post(
                    "http://localhost:8082/user/Playerprofile",
                    { playerId: playerId },
                    {
                        headers: {
                        ...
                        <MDBCard className="mb-4">
                            <MDBCardBody>
                                ...
                                <MDBRow className="align-items-center">
                                    ...
                                    <MDBCol sm="9">
                                        <MDBCardText className="text-muted">
                                            {profile && (profile.profile.strike_rate).toFixed(2)}
                                            {!profile && "-"}
                                ...
                                <MDBRow className="align-items-center">
                                    ...
                                    <MDBCol sm="9">
                                        <MDBCardText className="text-muted">
                                            {profile && profile.profile.wicket}
                                            {!profile && "-"}
                                ...
                                <MDBRow className="align-items-center">
                                    ...
                                    <MDBCol sm="9">
                                        <MDBCardText className="text-muted">
                                            {profile && profile.profile.economy.toFixed(2)}
                                            {!profile && "-"}
